...
if (isset($HTTP_POST_VARS['no'])) {
  $colname_Recordset1 = (get_magic_quotes_gpc()) ? $HTTP_POST_VARS['no'] : addslashes($HTTP_POST_VARS['no']);
}
mysql_select_db($database_DBtur, $DBtur);
$query_Recordset1 = sprintf("SELECT * FROM kontak WHERE `no` = %s", $colname_Recordset1);
          ...
          <td valign="top" ><table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr class="blok"> 
                ...
                <th align="center" valign="top"> <div align="center" class="isi"> 
                    ...
                    <form name="form1" method="post" action="hapus_data_contact.php">
                      <div align="left"> 
                        <table width="90%" border="0" cellspacing="0" cellpadding="0">
                          <tr class="isi"> 
                            <td>Nomor</td>
                            <td> <input name="no" type="text" id="kode_paket2" value="<?php echo $row_Recordset1['no']; ?>" size="5" readonly="1"></td>
                          </tr>
                          <tr class="isi"> 
                            <td>Nama</td>
                          ...
                          <tr class="isi"> 
                            <td>Komentar</td>
                            <td> <textarea name="textarea" cols="30" rows="6" readonly="1"><?php echo $row_Recordset1['komentar']; ?></textarea></td>
                          </tr>
                          <tr class="isi"> 
                            <td>&nbsp;</td>
