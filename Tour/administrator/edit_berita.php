...
mysql_select_db($database_DBtur, $DBtur);
$query_Recordset1 = "SELECT ID_berita, tanggal, sinopsis, judul, isi FROM berita";
                  ...
                  <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
                    <table align="center">
                      <tr valign="baseline" class="isi"> 
                        <td align="right" nowrap><div align="left">ID_berita:</div></td>
                        <td><?php echo $row_Recordset1['ID_berita']; ?></td>
                      </tr>
                      <tr valign="baseline" class="isi"> 
                        <td align="right" nowrap><div align="left">Tanggal:</div></td>
                        <td> <input type="text" name="tanggal" value="<?php echo $row_Recordset1['tanggal']; ?>" size="32"></td>
                      </tr>
                      <tr valign="baseline" class="isi"> 
                        <td align="right" valign="top" nowrap><div align="left">Sinopsis:</div></td>
                        <td> <textarea name="sinopsis" cols="50" rows="5"><?php echo $row_Recordset1['sinopsis']; ?></textarea> 
                        </td>
                      </tr>
                      <tr valign="baseline" class="isi"> 
                        <td align="right" nowrap><div align="left">Judul:</div></td>
                        <td> <input type="text" name="judul" value="<?php echo $row_Recordset1['judul']; ?>" size="32"></td>
                      </tr>
                      <tr valign="baseline" class="isi"> 
                        <td align="right" valign="top" nowrap><div align="left">Isi:</div></td>
                        <td> <textarea name="isi" cols="50" rows="5"><?php echo $row_Recordset1['isi']; ?></textarea> 
                        </td>
                      </tr>
                      <tr valign="baseline" class="isi"> 
                        <td align="right" nowrap>&nbsp;</td>
                        <td> <input type="submit" value="Update Berita"></td>
                      </tr>
                    </table>
