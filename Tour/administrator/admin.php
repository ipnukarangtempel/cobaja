...
<table id="Table_01" width="1024" height="721" border="0" cellpadding="0" cellspacing="0">
  <!--DWLayoutTable-->
  <tr> 
    <td height="97" colspan="12">&nbsp; <?php include('../include/atas.htm') ?>
    </td>
  </tr>
  <tr> 
              ...
              <tr class="blok"> 
                ...
                <td valign="top"> <div align="center" class="isi"> 
                    <p align="left" class="judul"><img src="images/icon_home.gif" width="21" height="22"> 
                      SELAMAT DATANG </p>
                    <p align="left">Selamat datang di menu administrasi<br>
                      Silahkan memilih menu administrasi yang diinginkan</p>
                  </div></td>
                <td>&nbsp;</td>
              </tr>
              <tr class="blok"> 
