    ...
    <td colspan="9" rowspan="2" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr> 
          ...
          <td valign="top" ><table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr class="blok"> 
                <td height="969">&nbsp;</td>
                <td colspan="2" valign="top">&nbsp; <table width="797" border="0" cellpadding="1" cellspacing="1">
                    <tr bgcolor="#999999" class="isi"> 
                      <td width="16">No</td>
                      <td width="106">Nama</td>
                      <td width="146">Alamat</td>
                      <td width="160">Email</td>
                      <td width="340">Komentar</td>
                    </tr>
                    <?php do { ?>
                    <tr bgcolor="#CCCCCC" class="isi"> 
                      <td><?php echo $row_Q1['no']; ?></td>
                      <td><?php echo $row_Q1['nama']; ?></td>
                      <td><?php echo $row_Q1['alamat']; ?></td>
                      <td><?php echo $row_Q1['email']; ?></td>
                      <td><?php echo $row_Q1['komentar']; ?></td>
                    </tr>
