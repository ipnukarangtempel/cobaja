          ...
          <td valign="top" ><table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr class="blok"> 
                ...
                <td valign="top"><p>&nbsp; <span class="isi">Masukkan data-data 
                    paket tur yang diperlukan</span> </p>
                  <form action="<?php echo $editFormAction; ?>" method="post" enctype="multipart/form-data" name="form1">
                    <table align="center">
                      <tr valign="baseline"> 
                        <td align="right" nowrap class="isi"><div align="left">Kode 
                            Paket:</div></td>
                        <td><input name="Kode_paket" type="text" value="" size="5" maxlength="5"></td>
                      </tr>
                      <tr valign="baseline"> 
                      ...
                      <tr valign="baseline"> 
                        ...
                        <td> <textarea name="Deskripsi" cols="50" rows="8"></textarea> 
                        </td>
                      </tr>
                      <tr valign="baseline"> 
                      ...
                      <tr valign="baseline"> 
                        ...
                        <td><input type="text" name="Harga" value="" size="10"></td>
                      </tr>
                      <tr valign="baseline"> 
