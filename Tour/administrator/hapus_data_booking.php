...
if ((isset($HTTP_POST_VARS['kode_booking'])) && ($HTTP_POST_VARS['kode_booking'] != "")) {
  $deleteSQL = sprintf("DELETE FROM booking WHERE kode_booking=%s",
                       GetSQLValueString($HTTP_POST_VARS['kode_booking'], "int"));

  mysql_select_db($database_DBtur, $DBtur);
  $Result1 = mysql_query($deleteSQL, $DBtur) or die(mysql_error());
}
?>
    ...
    <td colspan="9" rowspan="2" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr> 
          ...
          <td valign="top" ><table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr class="blok"> 
                <td height="72">&nbsp;</td>
                <td valign="top"><p class="isi">Data booking sudah terhapus....</p>
                  <p></p>
                  <p>&nbsp;</p></td>
                <td>&nbsp;</td>
              </tr>
