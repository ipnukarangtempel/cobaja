...
$query_Recordset1 = "SELECT ID_berita, judul FROM berita";
    ...
    <td colspan="9" rowspan="2" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr> 
          ...
          <td valign="top" ><table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr class="blok"> 
                ...
                <td valign="top"> <div align="center" class="isi"> 
                    <p align="left" class="judul"><img src="images/icon_home.gif" width="21" height="22"> 
                      PILIH JUDUL BERITA YANG AKAN DIHAPUS</p>
                    <p align="left">&nbsp;</p>
                  </div></td>
                <td>&nbsp;</td>
              </tr>
              <tr class="blok"> 
                <td height="580">&nbsp;</td>
                <td valign="top"> <form name="form1" method="post" action="detail_berita.php">
                    <p class="isi">Silahkan pilih judul yang ingin dihapus dan 
                      lihat dulu detailnya.</p>
                    <p class="isi"> 
                      <select name="ID_berita" id="ID_berita" title="anu">
                        <?php
do {  
?>
                        <option value="<?php echo $row_Recordset1['ID_berita']?>"><?php echo $row_Recordset1['judul']?></option>
                        <?php
