...
if (isset($HTTP_POST_VARS['UserId'])) {
  $colname_Recordset1 = (get_magic_quotes_gpc()) ? $HTTP_POST_VARS['UserId'] : addslashes($HTTP_POST_VARS['UserId']);
}
mysql_select_db($database_DBtur, $DBtur);
$query_Recordset1 = sprintf("SELECT UserId, UserName, NamaLengkap FROM `user` WHERE UserId = %s", $colname_Recordset1);
          ...
          <td valign="top" ><table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr class="blok"> 
                ...
                <th align="center" valign="top"> <div align="center" class="isi"> 
                    ...
                    <form name="form1" method="post" action="hapus_data_user.php">
                      <div align="left"> 
                        <table width="90%" border="0" cellspacing="0" cellpadding="0">
                          <tr class="isi"> 
                            <td>ID</td>
                            <td> <input name="UserId" type="text" id="kode_paket2" value="<?php echo $row_Recordset1['UserId']; ?>" size="5" readonly="1"></td>
                          </tr>
                          <tr class="isi"> 
                            <td>Nama</td>
                            <td> <input name="nama" type="text" id="nama3" value="<?php echo $row_Recordset1['UserName']; ?>" size="20" readonly="1"></td>
                          </tr>
                          <tr class="isi"> 
                            <td>Nama Lengkap</td>
                            <td> <input name="NamaLengkap" type="text" id="NamaLengkap" value="<?php echo $row_Recordset1['NamaLengkap']; ?>" size="30" readonly="1"></td>
                          </tr>
                          <tr class="isi"> 
                            <td>&nbsp;</td>
