...
$query_Q1 = "SELECT UserId, UserName, NamaLengkap FROM `user`";
    ...
    <td colspan="9" rowspan="2" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr> 
          ...
          <td valign="top" ><table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr class="blok"> 
                <td height="969">&nbsp;</td>
                <td colspan="2" valign="top">&nbsp; <table width="549" border="0" cellpadding="1" cellspacing="1">
                    <tr bgcolor="#999999" class="isi"> 
                      <td width="54">ID</td>
                      <td width="204">Nama User</td>
                      <td width="271">Nama Lengkap</td>
                    </tr>
                    <?php do { ?>
                    <tr bgcolor="#CCCCCC" class="isi"> 
                      <td><?php echo $row_Q1['UserId']; ?></td>
                      <td><?php echo $row_Q1['UserName']; ?></td>
                      <td><?php echo $row_Q1['NamaLengkap']; ?></td>
                    </tr>
