...
if ((isset($HTTP_POST_VARS["MM_insert"])) && ($HTTP_POST_VARS["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO user (UserId, UserName, Password, NamaLengkap) VALUES (%s, %s, %s, %s)",
                       ...
                       GetSQLValueString($HTTP_POST_VARS['NamaLengkap'], "text"));
    ...
    <td colspan="9" rowspan="2" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr> 
          ...
          <td valign="top" ><table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr class="blok"> 
                ...
                <td colspan="2" valign="top"> <div align="center" class="isi"> 
                    <p align="left" class="judul"><img src="images/icon_home.gif" width="21" height="22"> 
                      TAMBAH DATA USER (ADMINISTRATOR)</p>
                    <p align="left">&nbsp;</p>
                  </div></td>
                <td>&nbsp;</td>
              </tr>
              <tr class="blok"> 
                <td height="367">&nbsp;</td>
                <td valign="top"><p>&nbsp; <span class="isi">Masukkan data-data 
                    user baru.</span></p>
                  <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
                    <table align="center">
                      <tr valign="baseline" class="isi"> 
                        <td align="right" nowrap><div align="left">UserName:</div></td>
                        <td> <input type="text" name="UserName" value="" size="20"></td>
                      </tr>
                      <tr valign="baseline" class="isi"> 
                        <td align="right" nowrap><div align="left">Password:</div></td>
                        <td> <input type="password" name="Password" value="" size="20"></td>
                      </tr>
                      <tr valign="baseline" class="isi"> 
                        <td align="right" nowrap><div align="left">NamaLengkap:</div></td>
