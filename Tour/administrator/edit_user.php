    ...
    <td colspan="9" rowspan="2" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr> 
          ...
          <td valign="top" ><table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr class="blok"> 
                ...
                <td valign="top"> <div align="center" class="isi"> 
                    <p align="left" class="judul"><img src="images/icon_home.gif" width="21" height="22"> 
                      EDIT DATA USER (ADMINISTRATOR)</p>
                    <p align="left">&nbsp;</p>
                  </div></td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr class="blok"> 
                <td height="580">&nbsp;</td>
                <td colspan="2" valign="top"><form method="post" name="form1" action="<?php echo $editFormAction; ?>">
                    <table align="center">
                      <!--DWLayoutTable-->
                      <tr valign="baseline"> 
                        <td width="41"></td>
                        <td width="65" align="right" nowrap class="isi"> <div align="left">ID</div></td>
                        <td width="335" class="isi"> <div align="left"> 
                            <input name="textfield" type="text" value="<?php echo $row_Recordset1['UserId']; ?>" size="3">
                          </div></td>
                      </tr>
                      <tr valign="baseline"> 
                        <td></td>
                        ...
                        <td class="isi"> <div align="left"> 
                            <input type="text" name="Nama" value="<?php echo $row_Recordset1['UserName']; ?>" size="30">
                          </div></td>
                      </tr>
                      <tr valign="baseline"> 
                        <td></td>
                        <td align="right" valign="top" nowrap class="isi"> <div align="left">Password</div></td>
                        <td class="isi"> <div align="left"> 
                            <input name="textfield2" type="password" value="<?php echo $row_Recordset1['Password']; ?>">
                            (hati hati, jika mengganti password ini</div></td>
                      </tr>
                      <tr valign="baseline"> 
                        <td></td>
                        <td align="right" nowrap class="isi"> <div align="left">Nama 
                            lengkap </div></td>
                        <td class="isi"> <div align="left"> 
                            <input type="text" name="Harga" value="<?php echo $row_Recordset1['NamaLengkap']; ?>" size="20">
                          </div></td>
                      </tr>
                      <tr valign="baseline"> 
                        <td></td>
