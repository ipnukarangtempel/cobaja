...
if (isset($HTTP_POST_VARS['Kode_paket'])) {
  $colname_Recordset1 = (get_magic_quotes_gpc()) ? $HTTP_POST_VARS['Kode_paket'] : addslashes($HTTP_POST_VARS['Kode_paket']);
}
mysql_select_db($database_DBtur, $DBtur);
$query_Recordset1 = sprintf("SELECT * FROM paket_tur WHERE Kode_paket = '%s'", $colname_Recordset1);
          ...
          <td valign="top" ><table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr class="blok"> 
                ...
                <th align="center" valign="top"> <div align="center" class="isi"> 
                    ...
                    <form action="hapus_paket.php" method="post" name="form1">
                      <p align="left"> 
                        <input name="kode_paket" type="text" id="kode_paket" value="<?php echo $row_Recordset1['Kode_paket']; ?>" size="7" readonly="1">
                        <br>
                        <input name="nama" type="text" id="nama" value="<?php echo $row_Recordset1['Nama']; ?>" size="30" readonly="1">
                        <br>
                        <input name="harga" type="text" id="harga" value="<?php echo $row_Recordset1['Harga']; ?>" size="10" readonly="1">
                        <br>
                        <textarea name="Deskripsi" readonly="1" cols="30" rows="8" id="Deskripsi"> <?php echo $row_Recordset1['Deskripsi']; ?></textarea>
                      </p>
                      <p align="left"> 
