...
$query_Q1 = "SELECT * FROM berita ORDER BY tanggal ASC";
$Q1 = mysql_query($query_Q1, $DBtur) or die(mysql_error());
$row_Q1 = mysql_fetch_assoc($Q1);
$totalRows_Q1 = mysql_num_rows($Q1);
?>
    ...
    <td colspan="9" rowspan="2" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr> 
          ...
          <td valign="top" ><table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr class="blok"> 
                <td height="64">&nbsp;</td>
                <td colspan="2" valign="top">&nbsp; <table width="781" border="0" cellpadding="1" cellspacing="1">
                    <tr align="left" valign="top" bgcolor="#999999" class="isi"> 
                      <td width="50"> <div align="justify">ID</div></td>
                      <td width="68"> <div align="justify">Tanggal</div></td>
                      <td width="155"> <div align="justify">Judul</div></td>
                      <td width="156"> <div align="justify">Sinopsis</div></td>
                      <td width="335"> <div align="justify">Isi</div></td>
                    </tr>
                    <?php do { ?>
                    <tr align="left" valign="top" bgcolor="#CCCCCC" class="isi"> 
                      <td> 
                        <div align="left"><?php echo $row_Q1['ID_berita']; ?></div></td>
                      <td> 
                        <div align="left">
                          <?php $tgl =date("d M Y",strtotime($row_Q1['tanggal'])); echo $tgl;?>
                        </div></td>
                      <td> 
                        <div align="left"><?php echo $row_Q1['judul']; ?></div></td>
                      <td> 
                        <div align="left"><?php echo $row_Q1['sinopsis']; ?></div></td>
                      <td> 
                        <div align="left"><?php echo $row_Q1['isi']; ?></div></td>
                    </tr>
