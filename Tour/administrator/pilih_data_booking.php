...
$query_Recordset1 = "SELECT kode_booking, nama FROM booking ORDER BY nama ASC";
    ...
    <td colspan="9" rowspan="2" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr> 
          ...
          <td valign="top" ><table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr class="blok"> 
                <td height="580">&nbsp;</td>
                <td colspan="2" valign="top"> <form name="form1" method="post" action="detail_booking.php">
                    <p class="isi">Silahkan pilih data yang ingin dihapus dan 
                      lihat dulu detailnya.</p>
                    <p class="isi"> 
                      <select name="kode_booking" id="kode_booking" title="anu">
                        <?php
do {  
?>
                        <option value="<?php echo $row_Recordset1['kode_booking']?>"><?php echo $row_Recordset1['kode_booking']?></option>
                        <?php
