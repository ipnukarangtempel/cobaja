...
$query_Recordset1 = "SELECT UserId, UserName FROM `user`";
    ...
    <td colspan="9" rowspan="2" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr> 
          ...
          <td valign="top" ><table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr class="blok"> 
                <td height="580">&nbsp;</td>
                <td valign="top"> <form name="form1" method="post" action="detail_user.php">
                    <p class="isi">Silahkan pilih user yang ingin dihapus dan 
                      lihat dulu detailnya.</p>
                    <p class="isi"> 
                      <select name="UserId" id="UserId" title="anu">
                        <?php
do {  
?>
                        <option value="<?php echo $row_Recordset1['UserId']?>"><?php echo $row_Recordset1['UserName']?></option>
                        <?php
