    ...
    <td colspan="9" rowspan="2" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr> 
          ...
          <td valign="top" ><table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr class="blok"> 
                <td height="580">&nbsp;</td>
                <td colspan="2" valign="top"> <table border="0" cellpadding="1" cellspacing="1" bordercolor="#CCCCCC">
                    <tr bgcolor="#999999" class="isi"> 
                      <td width="66">Kode paket</td>
                      <td width="115">Nama</td>
                      <td width="509">Deskripsi</td>
                      <td width="43">Harga</td>
                    </tr>
                    <?php do { ?>
                    <tr class="isi"> 
                      <td bgcolor="#CCCCCC"><?php echo $row_Recordset1['Kode_paket']; ?></td>
                      <td bgcolor="#CCCCCC"><?php echo $row_Recordset1['Nama']; ?></td>
                      <td bgcolor="#CCCCCC"><div align="justify"><?php echo $row_Recordset1['Deskripsi']; ?></div></td>
                      <td bgcolor="#CCCCCC"><?php echo $row_Recordset1['Harga']; ?></td>
                    </tr>
