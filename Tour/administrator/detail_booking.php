...
if (isset($HTTP_POST_VARS['kode_booking'])) {
  $colname_Recordset1 = (get_magic_quotes_gpc()) ? $HTTP_POST_VARS['kode_booking'] : addslashes($HTTP_POST_VARS['kode_booking']);
}
mysql_select_db($database_DBtur, $DBtur);
$query_Recordset1 = sprintf("SELECT * FROM booking WHERE kode_booking = %s", $colname_Recordset1);
          ...
          <td valign="top" ><table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr class="blok"> 
                ...
                <th align="center" valign="top"> <div align="center" class="isi"> 
                    ...
                    <form name="form1" method="post" action="hapus_data_booking.php">
                      <div align="left"> 
                        <table width="90%" border="0" cellspacing="0" cellpadding="0">
                          <tr class="isi"> 
                            <td>Kode booking</td>
                            <td> <input name="kode_booking" type="text" id="kode_paket2" value="<?php echo $row_Recordset1['kode_booking']; ?>" size="5" readonly="1"></td>
                          </tr>
                          <tr class="isi">
                            <td>Tanggal Booking</td>
                            <td><input name="textfield5" type="text" value="<?php $tgl =date("d M Y",strtotime($row_Recordset1['tanggal'])); echo $tgl; ?>" readonly="1"></td>
                          </tr>
                          <tr class="isi"> 
                            <td>Nama</td>
                            <td> <input name="nama" type="text" id="nama3" value="<?php echo $row_Recordset1['nama']; ?>" size="30" readonly="1"></td>
                          </tr>
                          <tr class="isi"> 
                            <td>Alamat</td>
                            <td> <input name="textfield" type="text" value="<?php echo $row_Recordset1['alamat']; ?>" size="50" readonly="1"></td>
                          </tr>
                          <tr class="isi"> 
                            <td>Email</td>
                            <td> <input name="textfield2" type="text" value="<?php echo $row_Recordset1['email']; ?>" size="30" readonly="1"></td>
                          </tr>
                          <tr class="isi"> 
                            <td>Telepon</td>
                            <td> <input name="textfield3" type="text" value="<?php echo $row_Recordset1['telepon']; ?>" readonly="1"></td>
                          </tr>
                          <tr class="isi"> 
                            <td>Jml Orang </td>
                            <td> <input name="textfield4" type="text" value="<?php echo $row_Recordset1['jumlah_orang']; ?>" size="3" readonly="1"></td>
                          </tr>
                          <tr class="isi"> 
                            <td>Note</td>
                            <td> <textarea name="textarea" cols="30" rows="6" readonly="1"><?php echo $row_Recordset1['Note']; ?></textarea></td>
                          </tr>
                          <tr class="isi"> 
