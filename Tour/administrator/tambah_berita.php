...
if ((isset($HTTP_POST_VARS["MM_insert"])) && ($HTTP_POST_VARS["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO berita (ID_berita, tanggal, sinopsis, judul, isi) VALUES (%s, %s, %s, %s, %s)",
                       GetSQLValueString($HTTP_POST_VARS['ID_berita'], "text"),
                       GetSQLValueString($HTTP_POST_VARS['tanggal'], "date"),
                       GetSQLValueString($HTTP_POST_VARS['sinopsis'], "text"),
                       GetSQLValueString($HTTP_POST_VARS['judul'], "text"),
                       GetSQLValueString($HTTP_POST_VARS['isi'], "text"));
    ...
    <td colspan="9" rowspan="2" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr> 
          ...
          <td valign="top" ><table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr class="blok"> 
                <td height="367">&nbsp;</td>
                <td valign="top"><p>&nbsp; <span class="isi">Masukkan data untuk 
                    sebuah berita baru.</span> </p>
                  <p>&nbsp; 
                    <?
				  $today = getdate(); 
				  $month = $today['mon']; 
...
$tanggal=$month.$mday.$year;
//echo $tanggal;
?>
                  </p>
                  <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
                    <table align="center">
                      <tr valign="baseline" class="isi"> 
                        <td align="right" nowrap><div align="left">ID Berita:</div></td>
                        <td> <input type="text" name="ID_berita" value="" size="5"></td>
                      </tr>
                      <tr valign="baseline" class="isi"> 
                        <td align="right" nowrap><div align="left">Tanggal:</div></td>
                        <td> <input name="tanggal" type="text" readonly="1" value="<? echo "$year-$month-$mday $hours:$minutes:$seconds"; ?>" size="32"></td>
                      </tr>
                      <tr valign="baseline" class="isi"> 
                        <td align="right" valign="top" nowrap><div align="left">Sinopsis</div></td>
                        <td> <textarea name="sinopsis" cols="50" rows="5"></textarea> 
                        </td>
                      </tr>
                      <tr valign="baseline" class="isi"> 
                        <td align="right" nowrap><div align="left">Judul</div></td>
                        <td> <input type="text" name="judul" value="" size="50"></td>
                      </tr>
                      <tr valign="baseline" class="isi"> 
                        <td align="right" valign="top" nowrap><div align="left">Isi</div></td>
                        <td> <textarea name="isi" cols="50" rows="10"></textarea> 
                        </td>
                      </tr>
                      <tr valign="baseline" class="isi"> 
