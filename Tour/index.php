...
<table id="Table_01" width="1024" height="721" border="0" cellpadding="0" cellspacing="0">
  <!--DWLayoutTable-->
  <tr> 
    <td height="97" colspan="12"><img src="images/atas.png" alt="h" width="1024" height="195"></td>
  </tr>
  <tr> 
    ...
    <td colspan="9" rowspan="2" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr> 
          ...
          <td height="533" valign="top" class="blok"> <p align="center">&nbsp;</p>
            <p align="center" class="judul">CIPTOPRINT.COM </p>
            <blockquote> 
              <p align="justify">Platform cetak online cepat untuk memenuhi kebutuhan pribadi dan bisnis. Kami melayani pembuatan kartu nama, flyer, brosur, aneka merchandise, dan produk cetak premium berkualitas tinggi lainnya.</p>
              <p align="justify" class="isi"><em><br>
                <br>
                </em>CIPTOPRINT<br>
                Desain&amp;Cetak<br>
                telp : 085945568715<br>
                email : cs@ciptoprint.com</p>
          </blockquote></td>
        </tr>
        <tr>
          <td height="18"></td>
